...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    MOD = 267,
    LESS_THAN = 268,
    LESS_THAN_OR_EQUAL_TO = 269,
    BIGGER_THAN = 270,
    BIGGER_THAN_OR_EQUAL_TO = 271,
    INCREMENT = 272,
    DECREMENT = 273,
    NOT_EQUAL_TO = 274,
    EQUAL_TO = 275,
    ADDITION_AND_ASSIGNMENT_OPERATOR = 276,
    SUBSTRACT_AND_ASSIGNMENT_OPERATOR = 277,
    MULTIPLY_AND_ASSIGNMENT_OPERATOR = 278,
    DIVISION_AND_ASSIGNMENT_OPERATOR = 279,
    LOGICAL_AND_OPERATOR = 280,
    LOGICAL_OR_OPERATOR = 281,
    BITWISE_AND = 282,
    LOGICAL_NOT = 283,
    DELIMITERS = 284,
    KEYWORDS = 285,
...
{
  "$end", "error", "$undefined", "SINT", "FLOAT", "STRING", "SEMI",
  "ASSIGNOP", "PLUS", "SUB", "MULT", "DIV", "MOD", "LESS_THAN",
  "LESS_THAN_OR_EQUAL_TO", "BIGGER_THAN", "BIGGER_THAN_OR_EQUAL_TO",
  "INCREMENT", "DECREMENT", "NOT_EQUAL_TO", "EQUAL_TO",
  "ADDITION_AND_ASSIGNMENT_OPERATOR", "SUBSTRACT_AND_ASSIGNMENT_OPERATOR",
  "MULTIPLY_AND_ASSIGNMENT_OPERATOR", "DIVISION_AND_ASSIGNMENT_OPERATOR",
  "LOGICAL_AND_OPERATOR", "LOGICAL_OR_OPERATOR", "BITWISE_AND",
  "LOGICAL_NOT", "DELIMITERS", "KEYWORDS", "IDENTIFIER", "INTCONST",
  "STRINGS", "WHITESPACE", "ONE_LINE_COMMENTS", "NEWLINE", "'('", "')'",
  "$accept", "program", "type", "aid", "tim", "decl", "assign", YY_NULLPTR
};
#endif
...
{
     -31,     0,   -31,   -30,   -31,   -31,   -31,   -31,   -24,     1,
     -31,   -31,   -31,     3,    -2,   -31,   -31,   -31,   -31,     4,
     -31
};
...
{
       0,    40,     0,     1,     3,     4,     5,    31,    41,    42,
      44,    45,    36,    42,     7,     6,     4,    31,    32,    43,
       6
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4:
#line 66 "simple-parser.y"
                                { fprintf(yyout,"\n\t### Line:%d ERROR\n", line-1); errflag=1;}
#line 1370 "simple-parser.tab.c"
    break;

  case 6:
#line 71 "simple-parser.y"
                   { yyval = strdup(yytext); }
#line 1376 "simple-parser.tab.c"
    break;

  case 7:
#line 72 "simple-parser.y"
                           { yyval = strdup(yytext); }
#line 1382 "simple-parser.tab.c"
    break;

  case 8:
#line 73 "simple-parser.y"
                           { yyval = strdup(yytext); }
#line 1388 "simple-parser.tab.c"
    break;

  case 9:
#line 77 "simple-parser.y"
                        { yyval = strdup(yytext); }
#line 1394 "simple-parser.tab.c"
    break;

  case 10:
#line 80 "simple-parser.y"
                                { yyval ="SINT"; }
#line 1400 "simple-parser.tab.c"
    break;

  case 11:
#line 81 "simple-parser.y"
                 { yyval = "FLOAT";}
#line 1406 "simple-parser.tab.c"
    break;

  case 12:
#line 82 "simple-parser.y"
                        { yyval = "IDENTIFIER"; }
#line 1412 "simple-parser.tab.c"
    break;

  case 13:
#line 86 "simple-parser.y"
                        { fprintf(yyout,"\n\t### Line:%d Declaration\n", line);correctphrases++; }
#line 1418 "simple-parser.tab.c"
    break;

  case 14:
#line 91 "simple-parser.y"
                {
			if (strcmp(yyvsp[-1],"SINT"))
			{fprintf(yyout,"\n\t### Line:%d Variable assignment\n", line);correctphrases++;}
			
			else if (strcmp(yyvsp[-1],"FLOAT"))
			{fprintf(yyout,"\n\t### Line:%d Variable assignment\n", line);correctphrases++;}
...
#line 1437 "simple-parser.tab.c"
    break;


#line 1441 "simple-parser.tab.c"
